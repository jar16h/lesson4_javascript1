        ...
        *************************************************************************************************/
         ...
         function calculatePercentages() {
                  ...
                  *******************************************************************************************************/   
                  ...
                  shelterPct = 100 * (shelterAmt / 500);
                  foodPct = 100 * (foodAmt / 500);
                  householdPct = 100 * (householdAmt / 500);      
                  miscellaneousPct = 100 * (miscellaneousAmt / 500);  
                  transportationPct = 100 * (transportationAmt / 500);
